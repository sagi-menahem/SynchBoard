...
/**
 * A central place for holding application-wide constants.
 * This prevents magic numbers and strings in the code, improving
 * maintainability.
 */
public final class ApplicationConstants {
    ...
    public static final String API_BOARDS_WITH_SUBPATHS = "/api/boards/**"; // For specific board paths
    public static final String API_BOARDS_OBJECT = "/{boardId}/objects"; // For specific board paths
