...
public class UserController {
    ...
    public ResponseEntity<UserProfileDTO> updateUserPreferences(
        ...
        String userEmail = authentication.getName();
        log.debug(API_REQUEST_RECEIVED, "PUT", API_USER_BASE_PATH + API_USER_PREFERENCES, userEmail);
    ...
    public ResponseEntity<CanvasPreferencesDTO> updateCanvasPreferences(
        ...
        String userEmail = authentication.getName();
        log.debug(API_REQUEST_RECEIVED, "PUT", API_USER_BASE_PATH + API_USER_CANVAS_PREFERENCES, userEmail);

        CanvasPreferencesDTO updatedPreferences = userService.updateCanvasPreferences(userEmail, canvasPreferencesDTO);
        log.info(USER_PREFERENCES_UPDATED, userEmail);
    ...
    public ResponseEntity<ToolPreferencesDTO> updateToolPreferences(
        ...
        String userEmail = authentication.getName();
        log.debug(API_REQUEST_RECEIVED, "PUT", API_USER_BASE_PATH + API_USER_TOOL_PREFERENCES, userEmail);

        ToolPreferencesDTO updatedPreferences = userService.updateToolPreferences(userEmail, toolPreferencesDTO);
        log.info(USER_PREFERENCES_UPDATED, userEmail);
        return ResponseEntity.ok(updatedPreferences);
    }
    ...
    public ResponseEntity<LanguagePreferencesDTO> updateLanguagePreferences(
        ...
        String userEmail = authentication.getName();
        log.debug(API_REQUEST_RECEIVED, "PUT", API_USER_BASE_PATH + API_USER_LANGUAGE_PREFERENCES, userEmail);

        LanguagePreferencesDTO updatedPreferences = userService.updateLanguagePreferences(
            userEmail,
    ...
    public ResponseEntity<ThemePreferencesDTO> updateThemePreferences(
        ...
        String userEmail = authentication.getName();
        log.debug(API_REQUEST_RECEIVED, "PUT", API_USER_BASE_PATH + API_USER_THEME_PREFERENCES, userEmail);

        ThemePreferencesDTO updatedPreferences = userService.updateThemePreferences(userEmail, themePreferencesDTO);
        log.info(USER_PREFERENCES_UPDATED, userEmail);
        return ResponseEntity.ok(updatedPreferences);
    }
}
