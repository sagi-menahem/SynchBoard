...
import io.github.sagimenahem.synchboard.service.FileStorageService;
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (email == null || providerId == null) {
                log.error(SECURITY_PREFIX + " Missing required OAuth2 user data - email: {}, providerId: {}", 
            ...
            if (existingUser.isPresent()) {
                ...
                log.info(SECURITY_PREFIX + " Found existing user: email={}, authProvider={}, creationDate={}", 
                    email, user.getAuthProvider(), user.getCreationDate());
                
                // Check if existing user has same auth provider
