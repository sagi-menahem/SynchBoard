...
public final class LoggingConstants {
        ...
        public static final String AUTH_LOGIN_ATTEMPT =
                        SECURITY_PREFIX + " Login attempt for user: {}";
        ...
        public static final String BOARD_MEMBER_ADDED = AUDIT_PREFIX
                        + " Member added to board. BoardId: {}, Member: {}, AddedBy: {}";
        public static final String BOARD_MEMBER_REMOVED = AUDIT_PREFIX
                        + " Member removed from board. BoardId: {}, Member: {}, RemovedBy: {}";
        public static final String BOARD_MEMBER_PROMOTED = AUDIT_PREFIX
                        + " Member promoted in board. BoardId: {}, Member: {}, PromotedBy: {}";
        ...
        public static final String FILE_UPLOAD_STARTED = FILE_PREFIX
                        + " File upload started. Filename: {}, User: {}, Size: {} bytes";
