 ...
 * consistent behavior across the application and provide a centralized location for configuration values
 * that control the collaborative drawing experience.
 */
